...
from .views import ConfirmUploadView, DocumentListView, EmbedDocumentView, PresignUploadView, ClassifyDocumentView
...
urlpatterns = [
    ...
    path("<str:doc_id>/classify/", ClassifyDocumentView.as_view(), name="document-classify"),
]
